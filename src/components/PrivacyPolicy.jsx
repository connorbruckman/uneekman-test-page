...
const PrivacyPolicy = () => {
  return (
    <div>
      <div>
        <PageHeader
          header="Uneekman Privacy Policy"
          description="Update date: August 17th, 2023"
        />

        <div className="container py-5">
          <div>
            <p>
              Uneekman ("us", "we", or "our") operates the
              https://www.uneekman.com/ website (the "Service").
            </p>
            <p>
          ...
          <div>
            <h3>Use of Data</h3>
            <p>UneekMan uses the collected data for various purposes:</p>
            <ul>
          ...
          <div>
            ...
            <p>
              UneekMan will take all steps reasonably necessary to ensure that
          ...
          <div>
            ...
            <p>
              UneekMan may disclose your Personal Data in the good faith belief
              that such action is necessary to:
            </p>
            <ul>
              <li>To comply with a legal obligation</li>
              <li>To protect and defend the rights or property of UneekMan</li>
              <li>
